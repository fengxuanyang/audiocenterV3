...
public interface AudioCenterHttpAPI {
    ...
    @GET("album/track/{id}")
    Observable<TrackResultVO> getTracks
    ...
    Observable<String> removeFavorite
    ...
    @GET("audio/favorite")
    Observable<FavoriteResultVO> getFavorites
...
//http://{server:port}/${path}/radio/province?uid=100&did=100&atoken=15sdf487sdf1s587df
    @GET("radio/province")
    Observable<RadioResultVO> getRadiosByProvince
    (@Query("uid") int uid, @Query("did") int did, @Query("atoken") String atoken);
